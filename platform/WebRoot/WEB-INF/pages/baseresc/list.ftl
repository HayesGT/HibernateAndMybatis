...
<#--css样式文件和jquery -->
<#include "/assets.ftl">
<link href="${path}/assets/global/plugins/jquery-treetable/css/jquery.treetable.theme.default.css" rel="stylesheet" type="text/css"/>
<script src="${path}/assets/global/plugins/jquery-treetable/jquery.treetable.js" type="text/javascript"></script>
<#--自定义css样式和脚本-->
...
<script type="text/javascript">
    ...
    function add(pId){
        var _url = "${path}/baseresc/add/"+pId;
        var  _title="新增资源";
        top.dialog({
             id:'addUserDialog',
             url:_url,
    ...
    function edit(id){
        var _url = "${path}/baseresc/edit/"+id;
    	var  _title="编辑资源";
       top.dialog({
             id:'editUserDialog',
             url:_url,
	...
	<div class="page-bar">
		...
		<div class="page-toolbar">
		  ...
		  <div class="row">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form id="addForm" name="addForm" class="form-inline  form-right" action="${path}/baseresc/list" method="post" style="width:100%">
			    ...
			    <#list list as r>
			      <tr id="${r.id}">
			        ...
			        <td>
			          ...
			          <a href='javascript:void(0);' onclick="add('${r.id}');">新增</a> 
