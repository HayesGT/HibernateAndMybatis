 ...
 */
public  interface IMybatisBaseDao<T extends IdEntity,ID extends Serializable > {
	/**
	 * 功能说明：保存实体
	 * @author ducc
	...
	/**
	 * 功能说明：根据<select id="">的id和  map来查询
	 * @author ducc
	 * @created 2014年8月15日 下午1:07:34
	 * @updated 
	 * @param keyId  映射查询sql的id
	 * @param map
	 * @return
	 */
