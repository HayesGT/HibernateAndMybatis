...
public class GsonUtil {
    ...
    /**
     * 功能说明：序列化json字符串（不需要再类上写注解）
     * @author ducc
     * @created 2014年7月25日 下午2:18:18
     * @updated 
     * @param src
     * @return
     */
	public static String toJsonNoAnnotation(Object src) {
		return  GSON.toJson(src);
	}
	/**
	 * 功能说明：序列化json字符串（根据自定义类型）
	 * @author ducc
	 * @created 2014年7月25日 下午2:19:50
	 * @updated 
	 * @param src 数据源
	 * @param t 自定义类型 
	 * @return
	 */
	public static String toJsonNoAnnotation(Object src,Type  t) {
